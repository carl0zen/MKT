...
<script id="detailViewTemplate" type="text/template">
	<div class="news-internal-content ">
		...
		<div class="widget banner-header">			
			...
			<div class="trama"></div>
			<img src="https://sites.accenture.com/publishing/Mexico/MKTDev/PublishingImages/strategybanner.png">
		</div>
		 <div class="headline">
			<h1>
				{{=title}}
...
<script id="newsItemTemplate" type="text/template">
	<div class="newsItem relevance-{{=relevance}} {{if(imageUrl){ }}hasImage {{ } }} {{if(videoId){ }}hasVideo {{ } }}" 
...
<div class="layout-news-detail" id="strategyView">
	<div class="content" >
